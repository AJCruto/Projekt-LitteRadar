...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title>PROJEKT LITTERADAR</title>

        <!-- Fonts -->
        <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
        <link href=<?php echo e(asset('agribilis-logo.png')); ?> rel="shortcut icon" type="image/x-icon">
...
<?php /**PATH C:\Users\User\Desktop\ProjektLitteradar\ProjekLitteradar API\resources\views/welcome.blade.php ENDPATH**/ ?>